src = src/freq.* src/pqueue.* src/llist.* src/tree.* src/huffman_coding.* src/main.*
obj = build/freq.o build/pqueue.o build/llist.o build/tree.o build/huffman_coding.o build/main.o
